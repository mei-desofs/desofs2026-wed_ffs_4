package com.desofs.comment.controller;
...
public class CommentController {
    ...
    public ResponseEntity<?> getComments(@PathVariable UUID taskId) {
        try {
            List<CommentResponse> comments = commentService.getCommentsForTask(taskId, currentUserEmail());
    ...
    public ResponseEntity<?> editComment(
        ...
        try {
            CommentResponse response = commentService.editComment(taskId, commentId, currentUserEmail(), request);
    ...
    public ResponseEntity<?> deleteComment(
            ...
            @PathVariable Long commentId) {
        try {
            commentService.deleteComment(taskId, commentId, currentUserEmail());
